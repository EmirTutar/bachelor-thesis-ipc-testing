...
\vspace{0.5em}
The overall interaction between the main repository and the test framework is illustrated in the following diagram:
...
\begin{center}
	\begin{tikzpicture}[
		...
		\node[repo, right=5.5cm of repo1] (repo2) {eCAL Tests Repository};
